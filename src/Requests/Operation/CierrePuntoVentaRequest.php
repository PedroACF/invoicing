...
class CierrePuntoVentaRequest extends BaseRequest{
    ...
    public $cuis = "";
    public $nit = "";
    public function __construct(SalePoint $salePoint, $salePointToDelete)
    {
        $config = app(ConfigService::class);
        $this->requestName = "SolicitudCierrePuntoVenta";
        $this->codigoAmbiente = $config->getEnvironment();
        $this->codigoPuntoVenta = $salePointToDelete->sin_code;
